export const technologiesData = [
  // FRONTEND
  {
    ...
    introImage: '/images/tech_frontend.png',
    ...
    features: [
      ...
      { id: 5, isImage: true, image: '/images/service_web_feature.png' },
  ...
  // BACKEND
  {
    ...
    introImage: '/images/tech_backend.png',
    ...
    features: [
      ...
      { id: 5, isImage: true, image: '/images/service_cloud_intro.png' },
  ...
  // MOBILE
  {
    ...
    introImage: '/images/tech_mobile.png',
    ...
    features: [
      ...
      { id: 5, isImage: true, image: '/images/service_mobile_intro.png' },
  ...
  // UI DEVELOPMENT
  {
    ...
    introImage: '/images/tech_uiDev.png',
    ...
    features: [
      ...
      { id: 5, isImage: true, image: '/images/service_ux_feature.png' }
    ],
    faq: [
  ...
  // DATABASE
  {
    ...
    introImage: '/images/tech_database.png',
